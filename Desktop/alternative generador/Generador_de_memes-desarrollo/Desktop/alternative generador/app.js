...
// // Cambio color de fondo de imagen
//---------------------------LUCIA-----------------------------//


backgroundColor.addEventListener('input', (event) => {
    const colorFondo = event.target.value;
    divImg.style.backgroundColor = colorFondo;
    backgroundColorNumber.innerHTML = colorFondo;
});

// -----DESCARGAR MEME-----

//Evento que utiliza la variable
//Seleccionamos el boton de descarga del meme, y le ponemos un "escuchador de eventos" que escuche cuando el usuario le hace click. Esto activa la funcion de descarga de la libreria y guarda una imagen del contenido de "container", que sería el meme completo.
